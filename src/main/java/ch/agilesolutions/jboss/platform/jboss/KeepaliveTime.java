...
public class KeepaliveTime {
    ...
    public KeepaliveTime withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public KeepaliveTime withTime(Integer time) {
        this.time = time;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof KeepaliveTime) == false) {
            return false;
        }
        KeepaliveTime rhs = ((KeepaliveTime) other);
