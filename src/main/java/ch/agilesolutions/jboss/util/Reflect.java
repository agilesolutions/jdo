...
public class Reflect {
	...
	public static WidgetType getType(Method someMethod) {
	...
	public static boolean isRequired(Method someMethod) {

		return someMethod.getAnnotation(Attribute.class).required();
	...
	public static Class<?> getRoot() {
		...
		Reflections reflections = new Reflections("ch.agilesolutions.jboss.model");
