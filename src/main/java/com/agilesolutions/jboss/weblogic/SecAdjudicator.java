...
public class SecAdjudicator {
    ...
    public SecAdjudicator withSecName(String secName) {
        this.secName = secName;
        return this;
    }
    ...
    public SecAdjudicator withXsiType(String xsiType) {
        this.xsiType = xsiType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecAdjudicator) == false) {
            return false;
        }
        SecAdjudicator rhs = ((SecAdjudicator) other);
