...
public class SecAuthorizer {
    ...
    public SecAuthorizer withSecName(String secName) {
        this.secName = secName;
        return this;
    }
    ...
    public SecAuthorizer withXmlnsXac(String xmlnsXac) {
        this.xmlnsXac = xmlnsXac;
        return this;
    }
    ...
    public SecAuthorizer withXsiType(String xsiType) {
        this.xsiType = xsiType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecAuthorizer) == false) {
            return false;
        }
        SecAuthorizer rhs = ((SecAuthorizer) other);
