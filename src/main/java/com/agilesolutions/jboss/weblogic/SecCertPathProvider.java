...
public class SecCertPathProvider {
    ...
    public SecCertPathProvider withSecName(String secName) {
        this.secName = secName;
        return this;
    }
    ...
    public SecCertPathProvider withXsiType(String xsiType) {
        this.xsiType = xsiType;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SecCertPathProvider) == false) {
            return false;
        }
        SecCertPathProvider rhs = ((SecCertPathProvider) other);
