...
import com.agilesolutions.jboss.data.DomainDao;
import com.agilesolutions.jboss.data.NexusDao;
import com.agilesolutions.jboss.data.ProfileDao;
import com.agilesolutions.jboss.model.Artefact;
import com.agilesolutions.jboss.model.Deployment;
import com.agilesolutions.jboss.model.Domains;
import com.agilesolutions.jboss.model.Environment;
import com.agilesolutions.jboss.model.Profile;
import com.agilesolutions.jboss.model.Tree;
import com.agilesolutions.jboss.process.ImportJson;
import com.agilesolutions.jboss.process.TemplateProcessor;
import com.agilesolutions.jboss.util.Reflect;
...
public class ProfileController extends AbstractController implements Serializable {
	...
	public void updateProfile() {
		...
		try {
			...
			message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Update instance " + classifier.getSimpleName(),
					classifierInstance.toString());
	...
	public void upload(FileUploadEvent event) {
		...
		try {
			...
			importJson.generateProfiles(event.getFile().getInputstream(), domain);
	...
	public void addDeployment() {
		...
		deployment.setDescription(String.format("%s.%s.%s-%s", selectedArtefact.getGroupId(),
				selectedArtefact.getArtifactId(), selectedArtefact.getPackaging(), selectedArtefact.getVersion()));
